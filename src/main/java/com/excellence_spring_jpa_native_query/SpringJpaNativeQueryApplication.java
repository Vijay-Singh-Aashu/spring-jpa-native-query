package com.excellence_spring_jpa_native_query;
...
import com.excellence_spring_jpa_native_query.model.Tutorial;
import com.excellence_spring_jpa_native_query.repository.TutorialRepository;

@SpringBootApplication
public class SpringJpaNativeQueryApplication implements CommandLineRunner {

	@Autowired
	private TutorialRepository tutorialRepository;

	public static void main(String[] args) {
		SpringApplication.run(SpringJpaNativeQueryApplication.class, args);
	}
	...
	public void run(String... args) throws Exception {
		...
		Date date1 = new SimpleDateFormat("yyyy-MM-dd").parse("2023-03-11");
		Date date2 = new SimpleDateFormat("yyyy-MM-dd").parse("2023-04-26");
		Date date3 = new SimpleDateFormat("yyyy-MM-dd").parse("2023-05-19");
